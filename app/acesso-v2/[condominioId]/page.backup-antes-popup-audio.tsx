          ...
          <section className="bg-slate-900 border border-green-500 rounded-3xl p-4">
            ...
            <div className="mt-4 space-y-3">
              <button
                ...
                className={
                  gravandoAudio
                    ? "w-full bg-red-600 text-white text-lg font-black py-3 rounded-2xl animate-pulse"
                    : "w-full bg-blue-600 hover:bg-blue-500 disabled:bg-gray-500 text-white text-lg font-black py-3 rounded-2xl"
                }
              >
                {gravandoAudio
                  ? "⏹️ PARAR GRAVAÇÃO"
              ...
              {audioBlob && (
                <div className="bg-slate-800 border border-blue-500/40 rounded-2xl p-4 space-y-3">
                  ...
                  <button
                    ...
                    disabled={enviandoAudio}
                    className="w-full bg-blue-500 hover:bg-blue-400 disabled:bg-gray-500 text-white text-lg font-black py-3 rounded-2xl"
                  >
